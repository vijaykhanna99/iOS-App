...
class NeumorphicView: UIView {
    ...
    private var isLayersAdded: Bool = false
    ...
    fileprivate func setup() {
        ...
        case .Pressed:
            ...
            self.layer.borderWidth = 2 //may be remove ----
            self.layer.borderColor = (UIColor.white.withAlphaComponent(0.01)).cgColor //may be remove ----
        }
    }
